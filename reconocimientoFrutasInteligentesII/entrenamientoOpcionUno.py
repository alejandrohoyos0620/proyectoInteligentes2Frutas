...
model.add(Conv2D(kernel_size=7,strides=2,filters=24,padding="same",activation="relu",name="capa_1"))
...
for train,test in kFold.split(X,Y):
    ...
    model.fit(X[train], Y[train], epochs=25,batch_size=140) #era 25 epocs y 140 batch
...
# Guardar modelo
ruta="models/modeloFrutasUno.h5"
model.save(ruta)
